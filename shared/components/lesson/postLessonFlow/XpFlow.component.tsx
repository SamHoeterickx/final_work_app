...
// TYPES
import { IXpFlowProps } from '@/shared/types/types';

export const XpFlowScreens: FC<IXpFlowProps> = ({ newUserXP, prevUserXP }) => {
    const { t } = useTranslation();

    const earnedXP = newUserXP - prevUserXP;
    ...
    return (
        <View style={styles.wrapper}>
            ...
            >
                <Text style={styles.tag}>{t('lesson.postFlow.xp.congrats')}</Text>
                <Text style={[baseStyles.h1, styles.earnedText]}>+{earnedXP} XP</Text>
            </Animated.View>
            ...
            >
                <Text style={styles.tag}>{t('lesson.postFlow.xp.newTotal')}</Text>
                <Text style={[baseStyles.h1, styles.totalText]}>{newUserXP} XP</Text>
            </Animated.View>
        </View>
    );
};
